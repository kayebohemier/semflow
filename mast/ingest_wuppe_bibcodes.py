...
"""
Read in the WUPPE bibliographic data; we also require the obscore table
...
if __name__=="__main__":
    ...
    if nargs in [3,4,5] :
        ...
        sys.stderr.write("Usage: {0} <MAST obscore map> <WUPPE bibcode> [conffile] [rdf|n3]\n".format(sys.argv[0]))
        sys.exit(-1)
